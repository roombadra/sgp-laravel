...
class OrganismControllerIndexTest extends BaseControllerTest
{
    ...
    public function test_should_pass_for_admin()
    {
        ...
        $response = $this->get('/api/organisms', $this->headers($token));
    ...
    public function test_should_not_pass_for_agent()
    {
    ...
    public function test_should_not_pass_for_supervisor()
    {
    ...
    public function test_should_not_pass_for_controller()
    {
